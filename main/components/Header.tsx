...
export default function Header() {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 border-b border-gray-200 pb-4 sm:pb-6 mb-4 sm:mb-6">
      <div className="w-24 h-24 rotate-230 sm:w-32 sm:h-32 flex-shrink-0 mx-auto sm:mx-0">
        <Image
          src="/headshot.jpg"
      ...
      <div className="flex-1 text-center sm:text-left">
        <h1 className="text-3xl sm:text-5xl font-bold tracking-tight mb-3 sm:mb-4">
          helloooo! i&apos;m <span className="underline">jacob fu</span>
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 sm:gap-x-8 gap-y-1 sm:gap-y-2 text-xs sm:text-sm">
          ...
          <div>• interested in building things</div>
          <div className="flex items-center gap-1">
            <a
              href="https://calendar.app.google/QCosZGTnWDNeiCuz6"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 px-2 py-1 border border-gray-300 rounded-full bg-white text-gray-700 hover:text-gray-900 hover:border-gray-400 transition-all"
            >
